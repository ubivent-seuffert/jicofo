 ...
 */
class IntraRegionRandomBridgeSelectionStrategy
    extends BridgeSelectionStrategy
{
    /**
     * Default constructor.
     */
    public IntraRegionRandomBridgeSelectionStrategy()
    {}
            ...
            String participantRegion)
    {
        ...
        if (conferenceBridges.isEmpty())
        {
            ...
            return notLoadedInRegionRandom(bridges, conferenceBridges, participantRegion).orElseGet(
                    () -> leastLoadedRandom(bridges, conferenceBridges, participantRegion).orElse(null));
        }
